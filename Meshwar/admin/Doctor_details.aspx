<%@ Page Title="Doctor detail" Language="C#" MasterPageFile="~/site2.Master" AutoEventWireup="true" CodeBehind="Doctor_details.aspx.cs" Inherits="Meshwar.admin.Doctor_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div style="width: 20%; margin: 0 auto;" class="newStyle3">
...
<div class="container" style="margin: 0 auto; display: flex;">
  <div style="flex: 1;">
    <table class="table-hover" style="background-color:mistyrose; border-radius:10%;width:100%">
      ...
      <tr>
        <td>Phone Number:</td>
        <td><asp:Label ID="lbphoneNumber" runat="server" Text="Label"></asp:Label></td>
      </tr>
      <tr>
        <td>Email:</td>
