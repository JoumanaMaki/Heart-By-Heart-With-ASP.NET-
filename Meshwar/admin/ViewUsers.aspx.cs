    ...
    public partial class ViewUsers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (String.Equals(sessionValue, "1", StringComparison.OrdinalIgnoreCase))
            {
                ...
                html += "<thead class='thead-dark'><tr><th>Name</th><th>Email</th><th>Role</th> <th>Edit</th> <th>Delete</th></tr></thead>";
                html += "<tbody>";
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    html += "<tr>";
                    html += "<td><a href='User_details.aspx?ID=" + row["Id"].ToString() + "'>" + row["username"].ToString() + "</a></td>";
                    html += "<td>" + row["email"].ToString() + "</td>";
                    html += "<td>" + role + "</td>";
                    html += "<td><a href='Edit_users.aspx?ID=" + row["Id"].ToString() + "'>  <img src ='images/edit.png'  style='width: 30px; height: 30px;'/></a></td>";
                    html += "<td><a href='Delete_users.aspx?ID=" + row["Id"].ToString() + "'>  <img src ='images/delete.png'  style='width: 30px; height: 30px;'/></a></td>";
                    html += "</tr>";
                }
