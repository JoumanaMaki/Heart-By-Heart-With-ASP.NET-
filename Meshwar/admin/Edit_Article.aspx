<%@ Page Title="Edit Article" Language="C#" MasterPageFile="~/site2.Master" AutoEventWireup="true" CodeBehind="Edit_Article.aspx.cs" Inherits="Meshwar.admin.Edit_Article" %>
     ...
     <table style="background-color:mistyrose;margin-top:20px;padding:10px;margin-left:20%;border-radius:10%" class="auto-style13">
         ...
         <tr>
            <td class="auto-style1" colspan="2">
                <h1><strong class="newStyle1">Edit Article</strong></h1>
            </td>
        </tr>

           <tr>
            <td class="auto-style10"><strong class="newStyle4">is_published:</strong></td>
   ...
   <td>    <asp:DropDownList ID="DropDownList1" runat="server">
        ...
        <tr>
            <td class="auto-style12" colspan="2">
                <asp:Button ID="btnSubmit" runat="server" BackColor="#990000" ForeColor="White" Text="Update" Width="112px" OnClick="btnSubmit_Click" />
&nbsp;&nbsp;&nbsp;
